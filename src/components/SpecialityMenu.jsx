...
const SpecialityMenu =() =>{
    return (
        <div className='flex flex-col items-center gap-4 py-16 □ text-gray-800' id='speciality'>
            <h1 className='text-5xl font-medium'>Identify by Resources </h1>
            <p className='sm:w-1/3 text-center text-sm'>Simply browse through our extensive list of resources, schedule your bookings hassle-free.</p>
